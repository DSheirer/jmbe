...
public class IMBEFrame
{
	...
	/**
	 * Quantized coefficient value offset.  The quantized value of each 
	 * coefficient is an unsigned value.  Subtract half of the maximum value to 
	 * normalize the quantized value to +/- about zero.  Contains offsets for 
	 * bit lengths of zero through ten.
	 */
...
//			System.out.println( "IMBEFrame - repeating previous frame" );
	...
	{
		L09( Bands.K03, new int[][] { { 2 }, new int[] { 3 }, new int[] { 4 }, new int[] { 5,8 }, new int[] { 6,9 }, new int[] { 7,10 } }, 
		...
		L10( Bands.K04, new int[][] { { 2 }, new int[] { 3 }, new int[] { 4,8 }, new int[] { 5,9 }, new int[] { 6,10 }, new int[] { 7,11 } }, 
		...
		L11( Bands.K04, new int[][] { { 2 }, new int[] { 3,8 }, new int[] { 4,9 }, new int[] { 5,10 }, new int[] { 6,11 }, new int[] { 7,12 } }, 
		...
		L12( Bands.K04, new int[][] { { 2,8 }, new int[] { 3,9 }, new int[] { 4,10 }, new int[] { 5,11 }, new int[] { 6,12 }, new int[] { 7,13 } }, 
		...
		L13( Bands.K05, new int[][] { { 2,8 }, new int[] { 3,9 }, new int[] { 4,10 }, new int[] { 5,11 }, new int[] { 6,12 }, new int[] { 7,13,14 } }, 
		...
		L14( Bands.K05, new int[][] { { 2,8 }, new int[] { 3,9 }, new int[] { 4,10 }, new int[] { 5,11 }, new int[] { 6,12,13 }, new int[] { 7,14,15 } }, 
		...
		L15( Bands.K05, new int[][] { { 2,8 }, new int[] { 3,9 }, new int[] { 4,10 }, new int[] { 5,11,12 }, new int[] { 6,13,14 }, new int[] { 7,15,16 } }, 
		...
		L16( Bands.K06, new int[][] { { 2,8 }, new int[] { 3,9 }, new int[] { 4,10,11 }, new int[] { 5,12,13 }, new int[] { 6,14,15 }, new int[] { 7,16,17 } }, 
		...
		L17( Bands.K06, new int[][] { { 2,8 }, new int[] { 3,9,10 }, new int[] { 4,11,12 }, new int[] { 5,13,14 }, new int[] { 6,15,16 }, new int[] { 7,17,18 } }, 
		...
		L18( Bands.K06, new int[][] { { 2,8,9 }, new int[] { 3,10,11 }, new int[] { 4,12,13 }, new int[] { 5,14,15 }, new int[] { 6,16,17 }, new int[] { 7,18,19 } }, 
		...
		L19( Bands.K07, new int[][] { { 2,8,9 }, new int[] { 3,10,11 }, new int[] { 4,12,13 }, new int[] { 5,14,15 }, new int[] { 6,16,17 }, new int[] { 7,18,19,20 } }, 
		...
		L20( Bands.K07, new int[][] { { 2,8,9 }, new int[] { 3,10,11 }, new int[] { 4,12,13 }, new int[] { 5,14,15 }, new int[] { 6,16,17,18 }, new int[] { 7,19,20,21 } }, 
		...
		L21( Bands.K07, new int[][] { { 2,8,9 }, new int[] { 3,10,11 }, new int[] { 4,12,13 }, new int[] { 5,14,15,16 }, new int[] { 6,17,18,19 }, new int[] { 7,20,21,22 } }, 
		...
		L22( Bands.K08, new int[][] { { 2,8,9 }, new int[] { 3,10,11 }, new int[] { 4,12,13,14 }, new int[] { 5,15,16,17 }, new int[] { 6,18,19,20 }, new int[] { 7,21,22,23 } }, 
		...
		L23( Bands.K08, new int[][] { { 2,8,9 }, new int[] { 3,10,11,12 }, new int[] { 4,13,14,15 }, new int[] { 5,16,17,18 }, new int[] { 6,19,20,21 }, new int[] { 7,22,23,24 } }, 
		...
		L24( Bands.K08, new int[][] { { 2,8,9,10 }, new int[] { 3,11,12,13 }, new int[] { 4,14,15,16 }, new int[] { 5,17,18,19 }, new int[] { 6,20,21,22 }, new int[] { 7,23,24,25 } }, 
		...
		L25( Bands.K09, new int[][] { { 2,8,9,10 }, new int[] { 3,11,12,13 }, new int[] { 4,14,15,16 }, new int[] { 5,17,18,19 }, new int[] { 6,20,21,22 }, new int[] { 7,23,24,25,26 } }, 
		...
		L26( Bands.K09, new int[][] { { 2,8,9,10 }, new int[] { 3,11,12,13 }, new int[] { 4,14,15,16 }, new int[] { 5,17,18,19 }, new int[] { 6,20,21,22,23 }, new int[] { 7,24,25,26,27 } }, 
		...
		L27( Bands.K09, new int[][] { { 2,8,9,10 }, new int[] { 3,11,12,13 }, new int[] { 4,14,15,16 }, new int[] { 5,17,18,19,20 }, new int[] { 6,21,22,23,24 }, new int[] { 7,25,26,27,28 } }, 
		...
		L28( Bands.K10, new int[][] { { 2,8,9,10 }, new int[] { 3,11,12,13 }, new int[] { 4,14,15,16,17 }, new int[] { 5,18,19,20,21 }, new int[] { 6,22,23,24,25 }, new int[] { 7,26,27,28,29 } }, 
		...
		L29( Bands.K10, new int[][] { { 2,8,9,10 }, new int[] { 3,11,12,13,14 }, new int[] { 4,15,16,17,18 }, new int[] { 5,19,20,21,22 }, new int[] { 6,23,24,25,26 }, new int[] { 7,27,28,29,30 } }, 
		...
		L30( Bands.K10, new int[][] { { 2,8,9,10,11 }, new int[] { 3,12,13,14,15 }, new int[] { 4,16,17,18,19 }, new int[] { 5,20,21,22,23 }, new int[] { 6,24,25,26,27 }, new int[] { 7,28,29,30,31 } }, 
		...
		L31( Bands.K11, new int[][] { { 2,8,9,10,11 }, new int[] { 3,12,13,14,15 }, new int[] { 4,16,17,18,19 }, new int[] { 5,20,21,22,23 }, new int[] { 6,24,25,26,27 }, new int[] { 7,28,29,30,31,32 } }, 
		...
		L32( Bands.K11, new int[][] { { 2,8,9,10,11 }, new int[] { 3,12,13,14,15 }, new int[] { 4,16,17,18,19 }, new int[] { 5,20,21,22,23 }, new int[] { 6,24,25,26,27,28 }, new int[] { 7,29,30,31,32,33 } }, 
		...
		L33( Bands.K11, new int[][] { { 2,8,9,10,11 }, new int[] { 3,12,13,14,15 }, new int[] { 4,16,17,18,19 }, new int[] { 5,20,21,22,23,24 }, new int[] { 6,25,26,27,28,29 }, new int[] { 7,30,31,32,33,34 } }, 
		...
		L34( Bands.K12, new int[][] { { 2,8,9,10,11 }, new int[] { 3,12,13,14,15 }, new int[] { 4,16,17,18,19,20 }, new int[] { 5,21,22,23,24,25 }, new int[] { 6,26,27,28,29,30 }, new int[] { 7,31,32,33,34,35 } }, 
		...
		L35( Bands.K12, new int[][] { { 2,8,9,10,11 }, new int[] { 3,12,13,14,15,16 }, new int[] { 4,17,18,19,20,21 }, new int[] { 5,22,23,24,25,26 }, new int[] { 6,27,28,29,30,31 }, new int[] { 7,32,33,34,35,36 } }, 
		...
		L36( Bands.K12, new int[][] { { 2,8,9,10,11,12 }, new int[] { 3,13,14,15,16,17 }, new int[] { 4,18,19,20,21,22 }, new int[] { 5,23,24,25,26,27 }, new int[] { 6,28,29,30,31,32 }, new int[] { 7,33,34,35,36,37 } }, 
		...
		L37( Bands.K12, new int[][] { { 2,8,9,10,11,12 }, new int[] { 3,13,14,15,16,17 }, new int[] { 4,18,19,20,21,22 }, new int[] { 5,23,24,25,26,27 }, new int[] { 6,28,29,30,31,32 }, new int[] { 7,33,34,35,36,37,38 } }, 
		...
		L38( Bands.K12, new int[][] { { 2,8,9,10,11,12 }, new int[] { 3,13,14,15,16,17 }, new int[] { 4,18,19,20,21,22 }, new int[] { 5,23,24,25,26,27 }, new int[] { 6,28,29,30,31,32,33 }, new int[] { 7,34,35,36,37,38,39 } },  
		...
		L39( Bands.K12, new int[][] { { 2,8,9,10,11,12 }, new int[] { 3,13,14,15,16,17 }, new int[] { 4,18,19,20,21,22 }, new int[] { 5,23,24,25,26,27,28 }, new int[] { 6,29,30,31,32,33,34 }, new int[] { 7,35,36,37,38,39,40 } }, 
		...
		L40( Bands.K12, new int[][] { { 2,8,9,10,11,12 }, new int[] { 3,13,14,15,16,17 }, new int[] { 4,18,19,20,21,22,23 }, new int[] { 5,24,25,26,27,28,29 }, new int[] { 6,30,31,32,33,34,35 }, new int[] { 7,36,37,38,39,40,41 } }, 
		...
		L41( Bands.K12, new int[][] { { 2,8,9,10,11,12 }, new int[] { 3,13,14,15,16,17,18 }, new int[] { 4,19,20,21,22,23,24 }, new int[] { 5,25,26,27,28,29,30 }, new int[] { 6,31,32,33,34,35,36 }, new int[] { 7,37,38,39,40,41,42 } }, 
		...
		L42( Bands.K12, new int[][] { { 2,8,9,10,11,12,13 }, new int[] { 3,14,15,16,17,18,19 }, new int[] { 4,20,21,22,23,24,25 }, new int[] { 5,26,27,28,29,30,31 }, new int[] { 6,32,33,34,35,36,37 }, new int[] { 7,38,39,40,41,42,43 } }, 
		...
		L43( Bands.K12, new int[][] { { 2,8,9,10,11,12,13 }, new int[] { 3,14,15,16,17,18,19 }, new int[] { 4,20,21,22,23,24,25 }, new int[] { 5,26,27,28,29,30,31 }, new int[] { 6,32,33,34,35,36,37 }, new int[] { 7,38,39,40,41,42,43,44 } }, 
		...
		L44( Bands.K12, new int[][] { { 2,8,9,10,11,12,13 }, new int[] { 3,14,15,16,17,18,19 }, new int[] { 4,20,21,22,23,24,25 }, new int[] { 5,26,27,28,29,30,31 }, new int[] { 6,32,33,34,35,36,37,38 }, new int[] { 7,39,40,41,42,43,44,45 } }, 
		...
		L45( Bands.K12, new int[][] { { 2,8,9,10,11,12,13 }, new int[] { 3,14,15,16,17,18,19 }, new int[] { 4,20,21,22,23,24,25 }, new int[] { 5,26,27,28,29,30,31,32 }, new int[] { 6,33,34,35,36,37,38,39 }, new int[] { 7,40,41,42,43,44,45,46 } }, 
		...
		L46( Bands.K12, new int[][] { { 2,8,9,10,11,12,13 }, new int[] { 3,14,15,16,17,18,19 }, new int[] { 4,20,21,22,23,24,25,26 }, new int[] { 5,27,28,29,30,31,32,33 }, new int[] { 6,34,35,36,37,38,39,40 }, new int[] { 7,41,42,43,44,45,46,47 } }, 
		...
		L47( Bands.K12, new int[][] { { 2,8,9,10,11,12,13 }, new int[] { 3,14,15,16,17,18,19,20 }, new int[] { 4,21,22,23,24,25,26,27 }, new int[] { 5,28,29,30,31,32,33,34 }, new int[] { 6,35,36,37,38,39,40,41 }, new int[] { 7,42,43,44,45,46,47,48 } }, 
		...
		L48( Bands.K12, new int[][] { { 2,8,9,10,11,12,13,14 }, new int[] { 3,15,16,17,18,19,20,21 }, new int[] { 4,22,23,24,25,26,27,28 }, new int[] { 5,29,30,31,32,33,34,35 }, new int[] { 6,36,37,38,39,40,41,42 }, new int[] { 7,43,44,45,46,47,48,49 } }, 
		...
		L49( Bands.K12, new int[][] { { 2,8,9,10,11,12,13,14 }, new int[] { 3,15,16,17,18,19,20,21 }, new int[] { 4,22,23,24,25,26,27,28 }, new int[] { 5,29,30,31,32,33,34,35 }, new int[] { 6,36,37,38,39,40,41,42 }, new int[] { 7,43,44,45,46,47,48,49,50 } }, 
		...
		L50( Bands.K12, new int[][] { { 2,8,9,10,11,12,13,14 }, new int[] { 3,15,16,17,18,19,20,21 }, new int[] { 4,22,23,24,25,26,27,28 }, new int[] { 5,29,30,31,32,33,34,35 }, new int[] { 6,36,37,38,39,40,41,42,43 }, new int[] { 7,44,45,46,47,48,49,50,51 } }, 
		...
		L51( Bands.K12, new int[][] { { 2,8,9,10,11,12,13,14 }, new int[] { 3,15,16,17,18,19,20,21 }, new int[] { 4,22,23,24,25,26,27,28 }, new int[] { 5,29,30,31,32,33,34,35,36 }, new int[] { 6,37,38,39,40,41,42,43,44 }, new int[] { 7,45,46,47,48,49,50,51,52 } }, 
		...
		L52( Bands.K12, new int[][] { { 2,8,9,10,11,12,13,14 }, new int[] { 3,15,16,17,18,19,20,21 }, new int[] { 4,22,23,24,25,26,27,28,29 }, new int[] { 5,30,31,32,33,34,35,36,37 }, new int[] { 6,38,39,40,41,42,43,44,45 }, new int[] { 7,46,47,48,49,50,51,52,53 } }, 
		...
		L53( Bands.K12, new int[][] { { 2,8,9,10,11,12,13,14 }, new int[] { 3,15,16,17,18,19,20,21,22 }, new int[] { 4,23,24,25,26,27,28,29,30 }, new int[] { 5,31,32,33,34,35,36,37,38 }, new int[] { 6,39,40,41,42,43,44,45,46 }, new int[] { 7,47,48,49,50,51,52,53,54 } }, 
		...
		L54( Bands.K12, new int[][] { { 2,8,9,10,11,12,13,14,15 }, new int[] { 3,16,17,18,19,20,21,22,23 }, new int[] { 4,24,25,26,27,28,29,30,31 }, new int[] { 5,32,33,34,35,36,37,38,39 }, new int[] { 6,40,41,42,43,44,45,46,47 }, new int[] { 7,48,49,50,51,52,53,54,55 } }, 
		...
		L55( Bands.K12, new int[][] { { 2,8,9,10,11,12,13,14,15 }, new int[] { 3,16,17,18,19,20,21,22,23 }, new int[] { 4,24,25,26,27,28,29,30,31 }, new int[] { 5,32,33,34,35,36,37,38,39 }, new int[] { 6,40,41,42,43,44,45,46,47 }, new int[] { 7,48,49,50,51,52,53,54,55,56 } }, 
		...
		L56( Bands.K12, new int[][] { { 2,8,9,10,11,12,13,14,15 }, new int[] { 3,16,17,18,19,20,21,22,23 }, new int[] { 4,24,25,26,27,28,29,30,31 }, new int[] { 5,32,33,34,35,36,37,38,39 }, new int[] { 6,40,41,42,43,44,45,46,47,48 }, new int[] { 7,49,50,51,52,53,54,55,56,57 } }, 
				new int[][] { { 9,24,52 }, { 10,25,53 }, { 26,54 }, { 27,55 }, { 28,56 }, { 11,29,57 }, { 30,69 }, { 31,70 }, { 71 }, { 72 }, { 73 }, { 74 }, { }, { 23,32,75 }, { 33,76 }, { 34,77 }, { 78 }, { 79 }, { 80 }, { 110 }, { }, { 46,111 }, { 47,112 }, { 113 }, { 114 }, { 115 }, { 116 }, { 117 }, { }, { 48,122 }, { 49,123 }, { 124 }, { 125 }, { 126 }, { }, { }, { }, { 50,127 }, { 128 }, { 129 }, { 130 }, { 131 }, { }, { }, { }, { }, { 51,132 }, { 137 }, { 138 }, { 139 }, { }, { }, { }, { }, { } }, 
		...
		private double getCoefficient( BinaryFrame frame, int harmonic )
		{
			...
			else
			{
				...
				double quantizedValue = 
					(double)frame.getInt( mQuantizedValueIndices[ index ] ) + 
