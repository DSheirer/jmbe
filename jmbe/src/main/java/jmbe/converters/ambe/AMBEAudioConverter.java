 ...
 */
public class AMBEAudioConverter implements IAudioConverter
{
    private final static Logger mLog = LoggerFactory.getLogger(AMBEAudioConverter.class);
