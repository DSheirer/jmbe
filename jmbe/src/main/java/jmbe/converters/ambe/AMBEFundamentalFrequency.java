...
/**
 * Fundamental frequency, harmonic count and frame type enumeration
 */
public enum AMBEFundamentalFrequency
{
    ...
    private int mHarmonicCount;
    private FrameType mFrameType;

    AMBEFundamentalFrequency(double frequency, int harmonicCount, FrameType frameType)
    {
        mFrequency = frequency;
        mHarmonicCount = harmonicCount;
