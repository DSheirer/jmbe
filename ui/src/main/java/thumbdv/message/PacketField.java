...
{
    PKT_ENCODER_CMODE(0x05),
    PKT_DECODER_CMODE(0x06),
    PKT_RATE_TABLE(0x09),
    PKT_RATE_PARAMETER(0x0A),
    PKT_INIT(0x0B),
    PKT_LOW_POWER(0x10),
    PKT_CHANNEL_FORMAT(0x15),
    PKT_SPEECH_FORMAT(0x16),
    PKT_CODEC_START(0x2A),
    PKT_CODEC_STOP(0x2B),
    PKT_PRODUCT_ID(0x30),
    ...
    PKT_CODEC_CFG(0x38),
    PKT_READY(0x39),
    PKT_PARITY_MODE(0x3F),
    PKT_CHANNEL_0(0x40),
    PKT_WRITE_I2C(0x44),
    PKT_CLEAR_CODEC_RESET(0x46),
    PKT_SET_CODEC_RESET(0x47),
    PKT_DISCARD_CODEC_SAMPLES(0x48),
    PKT_DELAY_NUMBER_MICRO_SECONDS(0x49),
    PKT_DELAY_NUMBER_NANO_SECONDS(0x4A),
    PKT_GAIN(0x4B),
    PKT_RTS_THRESHOLD(0x4E),


//TODO: these are constants ... move them into the messages where they are used
    //Speech packet values
    SPEECH_DATA(0x00),
    CHANNEL_DATA_HARD_SYMBOL(0x01),
    CMODE(0x02),
    SAMPLE_COUNT(0x03),
    TONE(0x08),
    CHANNEL_DATA_SOFT_SYMBOL(0x17),
    VOCODER(0x40),

//TODO: create a packet type enumeration
    //Packet Types
    PACKET_TYPE_CONTROL(0x00),
    PACKET_TYPE_DATA(0x01),
    PACKET_TYPE_SPEECH(0x02),

    UNKNOWN(0x00);

    private int mCode;

    PacketField(int code)
    {
        mCode = code;
    }
